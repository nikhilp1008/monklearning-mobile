...
function createStyles(scale: (n: number) => number, verticalScale: (n: number) => number) {
  return StyleSheet.create({
    ...
    topBarText: { flex: 1 },
    chapterTitle: { fontFamily: 'AnekLatin_700Bold', fontSize: scale(15), color: colors.ink },
    chapterMeta: { fontFamily: 'AnekLatin_700Bold', fontSize: scale(12), color: colors.faint },
    percent: { fontFamily: 'AnekLatin_800ExtraBold', fontSize: scale(11), color: colors.faint },
    ...
    topicsLabel: { fontFamily: 'AnekLatin_700Bold', fontSize: scale(13.5), color: colors.ink },
    ...
    positionText: { fontFamily: 'AnekLatin_700Bold', fontSize: scale(14.5), color: colors.ink },
    positionTotal: { fontFamily: 'AnekLatin_600SemiBold', color: colors.faint },
    ...
    stateTitle: { fontFamily: 'AnekLatin_700Bold', fontSize: scale(19), color: colors.ink },
    stateBody: {
    ...
    stateButtonText: { fontFamily: 'AnekLatin_600SemiBold', fontSize: scale(15), color: colors.paper },
  });
}
