/* ROUTES-FROM-COLUMN:BEGIN — generated by scripts/generate_widget_routing_docs.py; do not edit by hand.
   ...
   34 concept(s):
   - [biol11 ch9] Factors Affecting Enzyme Activity and Enzyme Inhibition
     Chunks state the curves directly: temperature 'rises to an optimum then falls sharply' (MCQ on the curve shape), each enzyme has a pH optimum, and sub
   - [biol11 ch14] Transport of Oxygen and the Oxygen Dissociation Curve
     Explicit figure: 'Oxygen-haemoglobin dissociation curve. X-axis pO2 (0-100 mmHg), Y-axis % saturation; sigmoid curve, dashed right-shifted (Bohr) and 
   - [biol12 ch11] Population Growth: Exponential and Logistic Models
     Explicit: 'Two growth curves on the same axes - N (y) vs t (x). Curve 1 J-shape dN/dt=rN. Curve 2 S-shape flattening to dashed line K.' Second chunk a
   - [biol12 ch13] Patterns of Biodiversity: Latitudinal Gradient and Species-Area Relationship
     Fig 13.1 quoted: LEFT arithmetic axes, species richness vs area as a rising rectangular hyperbola flattening to a plateau; RIGHT log-log, log S vs log
   - [chem11 ch6] Physical Equilibria and Characteristics of the Equilibrium State
     Chunk holds a figure spec: 'Two-curve plot, rate (y) vs time (x). Forward-rate curve starts high and falls; reverse starts at zero and rises. They mee
   - [chem12 ch1] Henry's Law and Solubility of Gases
     Chunk quotes 'Figure 1.2 Henry's law plot: p = K_H x is a straight line through the origin; a steeper slope (larger K_H) means lower solubility' at si
   - [chem12 ch2] Molar Conductivity and Its Variation with Dilution
     Top chunk is the figures page with axes: 'Lambda_m (S cm2 mol-1)' vs root c, 0-160, KCl strong vs CH3COOH weak, extrapolation to the intercept. An exp
   - [chem12 ch3] Arrhenius Equation and Temperature Dependence of Rate
     Chunks state 'a plot of ln k versus 1/T is a straight line of slope -Ea/R' and note JEE sets 'graphical ln k vs 1/T problems'. A closed-form plotted l
   - [chem12 ch3] First Order Kinetics and Half-Life
     Chunk quotes 'Figure 3.2 ... First order: log([R]0/[R]) vs t is linear through the origin with slope k/2.303' at 0.75, plus 'plot log[R] vs t, slope -
   - [chem12 ch4] Lanthanoid Contraction and Its Consequences
     Figures page plots 'Ln3+ ionic radius / pm' (85-110) against La...Lu, 'smooth, near-linear decrease', with Zr 160 / Hf 159 annotated. An actual plotte
   - [math11 ch2] Periodic Functions and Their Periods
     [re-read against xy_plot v3 on 2026-09-07, was gap_piecewise_plot] pieces, six bands of a sawtooth; renders at 343x236, 495x270 and 900x430 as build/t
   - [math11 ch12] Left-Hand, Right-Hand Limits and Existence of a Limit
     [re-read against xy_plot v3 on 2026-09-07, was gap_piecewise_plot] pieces, a two-piece jump; renders at 343x236, 495x270 and 900x430 as build/trees/xy
   - [math11 ch12] Limits of Greatest Integer and Modulus Functions
     [re-read against xy_plot v3 on 2026-09-07, was gap_piecewise_plot] pieces, six steps of a staircase; renders at 343x236, 495x270 and 900x430 as build/
   - [math12 ch6] Tangents and Normals to a Curve
     [re-read against xy_plot v3 on 2026-09-07, was gap_curve_with_tangent] tangent_kind tangent and normal at tangent_at; renders at 343x236, 495x270 and 
   - [math12 ch7] Indefinite Integrals of Standard Forms
     [re-read against xy_plot v3 on 2026-09-07, was gap_curve_family] mode family over c; renders at 343x236, 495x270 and 900x430 as build/trees/xy_plot@3.
   - [math12 ch8] Area Bounded by a Parabola and a Line
     Mixed: two clean cases (y=4x-x^2 with chord y=3, int_1^3; y=4-x^2 with line y=k) but top chunks are sideways parabolas y^2=4ax cut by the latus rectum
   - [math12 ch8] Area Under a Simple Curve Bounded by the Axes
     Example 1: 'area bounded by y=x^2+2, the x-axis, and the lines x=0 and x=2', A=int_0^2 (x^2+2)dx=20/3. Parabola above a line, region between them over
   - [math12 ch8] Area of Regions Involving Modulus and Piecewise-Defined Functions
     [re-read against xy_plot v3 on 2026-09-07, was gap_piecewise_region] pieces under mode area; renders at 343x236, 495x270 and 900x430 as build/trees/xy
   - [phys11 ch2] Average and Instantaneous Quantities
     c99/c100 give Figure 2.1: an x-t curve, secant chord AB labelled 'slope = average velocity', tangent at A labelled 'slope = instantaneous velocity', w
   - [phys11 ch2] Kinematic Quantities
     Sub-topic 01 is this concept, and c99/c100 render its Figure 2.1: an x-t curve with A(t1,x1), B(t2,x2), the secant chord 'slope = average velocity' an
   - [phys11 ch5] Potential Energy
     c399: 'A potential energy curve U(x) with a wavy shape showing one valley (Stable equilibrium) and one hilltop (Unstable equilibrium). A horizontal da
   - [phys11 ch5] Power
     [re-read against xy_plot v3 on 2026-09-07, was gap_area_under_curve] mode area over a P-t parabola; renders at 343x236, 495x270 and 900x430 as build/t
   - [phys11 ch7] Gravitational Potential Energy
     Figure 7.8 rendered in c637 with axes r(m) 0-5 and U(J) 0 to -4, annotated 'U = 0 at r->inf', 'U < 0 for all finite r', 'more negative -> more tightly
   - [phys11 ch8] Stress, Strain and Hooke's Law
     Figure 8.1 is drawn in c712: stress (GPa) against strain, with O->P proportional limit, E elastic limit, yield point, ultimate tensile strength, fract
   - [phys11 ch8] Stress-Strain Curve and Yielding
     [re-read against xy_plot v3 on 2026-09-07, was gap_stress_strain_curve] named stress_strain, the ductile curve with the yield landmarks (NCERT Fig 8.1
   - [phys11 ch10] Calorimetry and Specific Heat
     c922 (Subtopic 02 'Calorimetry and Specific Heat', Section 3) carries 'Figure 10.2 Heating curve for 1 kg of ice at -10 C warmed to steam: rising legs
   - [phys11 ch10] Change of State and Latent Heat
     c922: 'Figure 10.2 ... flat plateaus at 0 C (melting, m L_f = 336 kJ) and 100 C (boiling, m Lv = 2260 kJ - the long plateau)'; c929 cheat sheet repeat
   - [phys11 ch10] Newton's Law of Cooling
     [re-read against xy_plot v3 on 2026-09-07, was gap_cooling_curve] curve exponential, a*e^(bx)+c with the asymptote at c; renders at 343x236, 495x270 a
   - [phys11 ch13] Damped and Forced Oscillations
     [re-read against xy_plot v3 on 2026-09-07, was gap_resonance_curve] named resonance, three dampings; renders at 343x236, 495x270 and 900x430 as build/
   - [phys11 ch13] SHM Energy
     c1246/c1245 carry Figure 13.1: two stacked plots on one time axis, x=A sin(omega t) on top, K (cos^2) and U (sin^2) below with TWO humps per period, c
   - [phys12 ch7] Resonance and Q-Factor
     [re-read against xy_plot v3 on 2026-09-07, was gap_resonance_curve] named resonance, three dampings; renders at 343x236, 495x270 and 900x430 as build/
   - [phys12 ch13] Binding Energy Curve and Nuclear Force
     [re-read against xy_plot v3 on 2026-09-07, was gap_binding_energy_curve] named binding_energy; renders at 343x236, 495x270 and 900x430 as build/trees/
   - [phys12 ch13] Radioactive Decay Law and Half-Life
     Figure 13.5 is N = N0 e^-lambda*t with N0/2, N0/4, N0/8 at equal T1/2 spacing; expressible as curve=exponential a=1,b=-0.693,c=0, x 0..4, though most 
   - [phys12 ch14] V-I Characteristics and Biasing of p-n Junction Diode
     [re-read against xy_plot v3 on 2026-09-07, was gap_diode_iv_curve] named diode_iv; renders at 343x236, 495x270 and 900x430 as build/trees/xy_plot@3.ga
