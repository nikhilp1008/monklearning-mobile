/* ROUTES-FROM-COLUMN:BEGIN — generated by scripts/generate_widget_routing_docs.py; do not edit by hand.
   ...
   7 concept(s):
   - [phys11 ch3] Vector Algebra and Resolution
     c184/c185 render Figure 3.1: an O-P-Q parallelogram construction, A along OP, B at angle theta, resultant R = OQ, a perpendicular dropped to S marking
   - [phys11 ch4] Circular Motion Dynamics (Banking)
     c322 carries Figure 4.6: 'A vehicle on a road banked at angle theta; normal reaction N perpendicular to the tilted surface, resolved into N cos and N 
   - [phys11 ch4] Common Forces in Mechanics and Free-Body Diagrams
     c332: 'a body, isolated, with arrows for every force acting on it. That picture is a free-body diagram (FBD), and the arrows are drawn from a small, f
   - [phys11 ch4] Concurrent Forces and Equilibrium
     c294: 'if you drew their three force arrows head to tail, the arrows would close up into a triangle with no gap'. c296's Lami derivation lays the forc
   - [phys11 ch6] Rolling Motion
     c557 carries Figure 6.12: 'A sphere moving right with velocity v0 and zero spin, on a horizontal floor. Kinetic friction f acts backward at the contac
   - [phys11 ch9] Stokes' Law and Terminal Velocity
     Figure 9.10 (c847/c848): a small sphere of radius r falling through a liquid column with three force arrows - weight (4/3)pi r^3 rho_b g down, buoyanc
   - [phys11 ch13] Simple Pendulum
