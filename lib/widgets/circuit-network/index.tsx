/* ROUTES-FROM-COLUMN:BEGIN — generated by scripts/generate_widget_routing_docs.py; do not edit by hand.
   ...
   2 concept(s):
   - [phys12 ch2] Combination of Capacitors
     Chunks 1 and 2 are Fig 2.7 (C1,C2,C3 parallel across V) and Fig 2.6 (C1,C2,C3 series across V) — topology series with cell+3 capacitors, or parallel w
   - [phys12 ch3] Series and Parallel Combination of Resistors
