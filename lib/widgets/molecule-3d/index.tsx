/* ROUTES-FROM-COLUMN:BEGIN — generated by scripts/generate_widget_routing_docs.py; do not edit by hand.
   ...
   ZERO concepts route here at high confidence. That is a FINDING —
   it is exactly how field_lines sat wired-and-unused — not a gap in
   this file. Check the column before assuming the widget is used.
