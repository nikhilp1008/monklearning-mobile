...
export const PLACEHOLDER_FIGURE: FigureRecord = {
  ...
  groups: [
    { id: 'organelles', label: { english: 'Organelles', hinglish: 'Koshikang' } },
    { id: 'nucleus', label: { english: 'Nucleus', hinglish: 'Kendrak' } },
  ],
  labels: [
    {
      id: 'cell-wall',
      term: { english: 'Cell wall', hinglish: 'Koshika bhitti' },
    ...
    {
      id: 'plasma-membrane',
      term: { english: 'Plasma membrane', hinglish: 'Jeevadravya jhilli' },
    ...
    {
      id: 'cytoplasm',
      term: { english: 'Cytoplasm', hinglish: 'Koshikadravya' },
      anchor: { u: 0.3, v: 0.7 },
      side: 'left',
      group: 'organelles',
    },
    {
      id: 'vacuole',
      term: { english: 'Vacuole', hinglish: 'Rasdhani' },
    ...
    {
      id: 'mitochondrion',
      term: { english: 'Mitochondrion', hinglish: 'Sutrakanika' },
    ...
    {
      id: 'nuclear-envelope',
      term: { english: 'Nuclear envelope', hinglish: 'Kendrak kala' },
    ...
    {
      id: 'nucleoplasm',
      term: { english: 'Nucleoplasm', hinglish: 'Kendrakadravya' },
      anchor: { u: 0.47, v: 0.4 },
      side: 'right',
      group: 'nucleus',
    },
    {
      id: 'nucleolus',
      term: { english: 'Nucleolus', hinglish: 'Kendrika' },
