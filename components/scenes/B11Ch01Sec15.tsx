  ...
  return (
    <Scene>
      ...
      <Fade on={beat >= 1 && beat < 4} delay={dl(1, 0.3)}>
        <SvgText x={60} y={120} fontStyle="italic" fontWeight={700} fontSize={16} fill={GREEN} fontFamily='Onest_700Bold'>
          Brassica oleracea
        </SvgText>
      ...
      <Fade on={beat >= 1 && beat < 4} delay={dl(1, 1.4)}>
        <SvgText x={60} y={150} fontStyle="italic" fontWeight={700} fontSize={16} fill={GREEN} fontFamily='Onest_700Bold'>
          Brassica oleracea
        </SvgText>
      ...
      <Fade on={beat >= 1 && beat < 4} delay={dl(1, 2.5)}>
        <SvgText x={60} y={180} fontStyle="italic" fontWeight={700} fontSize={16} fill={AMBER_DARK} fontFamily='Onest_700Bold'>
          Brassica nigra
        </SvgText>
