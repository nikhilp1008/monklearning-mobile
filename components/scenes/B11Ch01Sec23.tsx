  ...
  return (
    <Scene>
      ...
      <Fade on={beat >= 1 && beat < 4} delay={dl(1, 1)}>
        <SvgText x={300} y={169} textAnchor="middle" fontStyle="italic" fontWeight={700} fontSize={16} fill={GREEN} fontFamily='Onest_700Bold'>
          Corvus
        </SvgText>
      </Fade>
      ...
      <Fade on={beat >= 1 && beat < 4} delay={dl(1, 1.3)}>
        <SvgText x={780} y={169} textAnchor="middle" fontStyle="italic" fontWeight={700} fontSize={16} fill={AMBER_DARK} fontFamily='Onest_700Bold'>
          Pavo
        </SvgText>
      </Fade>
