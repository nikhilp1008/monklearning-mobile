  ...
  return (
    <Scene>
      ...
      <Fade on={beat >= 3} delay={dl(3, 4.2)}>
        <SvgText x={95} y={340} textAnchor="middle" fontSize={11} fill={RED} fontFamily='Onest_600SemiBold' transform="rotate(-90 95 340)">
          {t("organisms increase ↑", "organisms increase ↑")}
        </SvgText>
      </Fade>
      <Fade on={beat >= 3} delay={dl(3, 4.5)}>
        <SvgText x={985} y={340} textAnchor="middle" fontSize={11} fill={GREEN} fontFamily='Onest_600SemiBold' transform="rotate(90 985 340)">
