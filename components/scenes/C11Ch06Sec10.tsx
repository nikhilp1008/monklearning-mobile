  ...
  return (
    <Scene>
      ...
      <Fade on={beat >= 5} delay={dl(5, 0.4)}>
        <SvgText x={540} y={300} textAnchor="middle" fontSize={15} fill={MUTED} fontFamily='Onest_600SemiBold'>
      ...
      <Fade on={beat >= 5} delay={dl(5, 1.1)}>
        <SvgText x={540} y={335} textAnchor="middle" fontSize={19} fontWeight={700} fill={INK} fontFamily='Onest_700Bold'>
      ...
      <Fade on={beat >= 6} delay={dl(6, 0.4)}>
        <SvgText x={540} y={375} textAnchor="middle" fontSize={16} fill={INK} fontFamily='Onest_600SemiBold'>
      ...
      <Fade on={beat >= 7} delay={dl(7, 0.4)}>
        <SvgText x={540} y={440} textAnchor="middle" fontSize={26} fontWeight={800} fill={GREEN} fontFamily='Onest_800ExtraBold'>
