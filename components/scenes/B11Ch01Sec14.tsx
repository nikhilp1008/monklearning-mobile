  ...
  return (
    <Scene>
      ...
      <Fade on={beat >= 2 && beat < 4} delay={dl(2, 0.7)}>
        <SvgText x={375} y={222} textAnchor="middle" fontSize={19} fontWeight={700} fontStyle="italic" fill={AMBER_DARK} fontFamily='Onest_700Bold'>
          Felis
        </SvgText>
        <SvgText x={460} y={222} textAnchor="middle" fontSize={19} fontWeight={700} fontStyle="italic" fill={AMBER_DARK} fontFamily='Onest_700Bold'>
          catus
        </SvgText>
      </Fade>
      ...
      <Fade on={beat >= 2 && beat < 4} delay={dl(2, 2.1)}>
        <SvgText x={375} y={260} textAnchor="middle" fontSize={19} fontWeight={700} fill={INK} fontFamily='Onest_700Bold'>
          Felis
        </SvgText>
        <SvgText x={460} y={260} textAnchor="middle" fontSize={19} fontWeight={700} fill={INK} fontFamily='Onest_700Bold'>
          catus
        </SvgText>
      </Fade>
